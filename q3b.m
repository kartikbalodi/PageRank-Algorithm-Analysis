...
% This method resolves in $1,972,504
...
% Greedy Algorithm - runs in $68,806
...
while getRank(1001, rnkDes) > 0.1*length(M) %Stopping condition - rank has been met
    ...
    for i = 1:length(visited) % Calculates the best possible unvisited webpage to add a connectoin to
